...
function changeshowattr(fieldid,fieldvalue,rownum,workflowid,nodeid){
    setTimeout(function(){
            changeshowattrAjax(fieldid,fieldvalue,rownum,workflowid,nodeid);
        }, 1000);
}   

function changeshowattrAjax(fieldid,fieldvalue,rownum,workflowid,nodeid){
            ...
            if(objTagname == "SELECT"){
                ...
                if(fieldattr==2){ //必填的时候增加必填标识
                    ...
                    if(jQuery("#field"+fieldid+"span").length>0&&jQuery("#field"+fieldid+"spanimg").length<1){
                        if(jQuery("#field"+fieldid+"span").indexOf("BacoError_wev8")!=-1){
                            jQuery("#field"+fieldid+"span").html("");
                        }
                    }
                    jQuery("#field"+fieldid+"").attr("viewtype","0");
                    ...
                    if(isedit>2){
                        ...
                        if(jQuery("#field"+fieldid+"span").indexOf("<IMG src='/images/BacoError_wev8.gif' align=absMiddle>")!=-1){
                            jQuery("#field"+fieldid+"span").html("");
                        }
                    }
                }
